...
'''
YouTube download tool. Install youtube-dl for downloading YouTube videos first.
'''
    ...
    for entry in content:
        ...
        for inst in instances:
            ...
            if os.path.exists(os.path.join(saveto, video_url[-11:] + '.mp4')) or os.path.exists(os.path.join(saveto, video_url[-11:] + '.mkv')):
                ...
                # avoid hitting the server too fast — this can be seen as abuse or even get you blocked.
